...
const Index = () => {
  ...
  const renderView = () => {
    switch (activeView) {
      ...
      case 'warehouses':
        return <WarehousesView stats={inventory.stats} items={inventory.allItems} warehouses={inventory.warehouses} onUpdateWarehouse={inventory.updateWarehouse} onUpdateStock={inventory.updateStock} />;
      case 'reports':
